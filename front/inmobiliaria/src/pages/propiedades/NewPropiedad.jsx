...
import { addItem } from '../../services/propiedadesApi';
...
const CrearPropiedadPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!domicilio.trim() || !fechaInicio.trim() || !dias.trim() || !valorNoche.trim()){
            setMessage({text:'No pueden contener campos vacios'});
        }else{
            try {
                const newProperty = {  
                    domicilio,
                ...
                const data = await addItem(newProperty);
...
export default CrearPropiedadPage;
